...
exports.cookieExtractor = function (req) {
  ...
  // token="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY3N2Y3NGNhMzI2MzQzNDRlNDk0Njk4YiIsInJvbGUiOiJ1c2VyIiwiaWF0IjoxNzM3MDM2MTk1fQ.vXsVxYUtlWWiHX6NcJvbJP6s8WX9k9oDGk6hi8HE-xE"
      return token;
};
...
<head>
  ...
  @media screen {
    @font-face {
      ...
      font-style: normal;
      font-weight: 400;
      src: local('Source Sans Pro Regular'), local('SourceSansPro-Regular'), url(https://tailwindui.com/plus/img/logos/mark.svg?color=indigo&shade=500) ;
    }
    ...
    @font-face {
      ...
      font-style: normal;
      font-weight: 700;
      src: local('Source Sans Pro Bold'), local('SourceSansPro-Bold'), url(https://tailwindui.com/plus/img/logos/mark.svg?color=indigo&shade=500);
    }
  }
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          <tr>
            <td align="center" valign="top" style="padding: 36px 24px;">
              <a href="https://tailwindui.com/plus/img/logos/mark.svg?color=indigo&shade=500" target="_blank" style="display: inline-block;">
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td align="left" bgcolor="#D2C7BA" width="75%" style="padding: 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;"><strong>Order #</strong></td>
                                    <td align="left" bgcolor="#D2C7BA" width="25%" style="padding: 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;"><strong>Qty</strong></td>
                ...
                <tr>
                  ...
                  <td align="left" width="25%" style="padding: 12px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-top: 2px dashed #D2C7BA; border-bottom: 2px dashed #D2C7BA;"><strong>${order.totalItems}</strong></td>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 300px;">
                  <tr>
                    <td align="left" valign="top" style="padding-bottom: 36px; padding-left: 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                      ...
                      <p>${order.selectedAddress.name}<br>${order.selectedAddress.street}<br>${order.selectedAddress.city}<br>${order.selectedAddress.state}<br>${order.selectedAddress.pincode}<br></p>
